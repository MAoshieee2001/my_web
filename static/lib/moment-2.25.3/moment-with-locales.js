;(function (global, factory) {
    ...
    var defaultLocaleMeridiemParse = /[ap]\.?m?\.?/i,
        // Setting the hour should keep the time, because the accounts explicitly
        ...
        if (key) {
            ...
            if (data) {
                ...
                if (typeof console !== 'undefined' && console.warn) {
                    //warn accounts if arguments are passed but the locale could not be set
                    console.warn(
    ...
    hooks.defineLocale('uk', {
        ...
        // M. E.: those two are virtually unused but a accounts might want to implement them for his/her website for some reason
